...
platform, but e.g. auchan.fr runs on completely different tech from
auchan.pt, so each site listed above has its own dedicated, verified
...
intermarche.pt, tienda.mercadona.es, or carrefour.es and search for a
product.
