...
function signalFromOwnMatch(match) {
  ...
  return {
    ...
    // as separate EN/PT/ES/FR/DE/IT fields through to render time (content/common.js)
    ...
    notesEs: match.notesEs || null,
    notesFr: match.notesFr || null,
    notesDe: match.notesDe || null,
    notesIt: match.notesIt || null
  };
}
